    ...
    return (
      <div className="howto-wrapper">
        <div className="howto-close-wrapper">
          <i className="howto-close fa fa-times" onClick={this.closeModal} />
        </div>
        ...
        <div className="howto-section">
          ...
          <p className="howto-section-text">
            Find the course you want to have in your calendar in the{' '}
            <TeachingLink lang="en">UTA teaching schedule</TeachingLink> (
            <TeachingLink lang="fi">Finnish one here</TeachingLink>
        ...
        <div className="howto-section">
          ...
          <p className="howto-section-text">
            Select the groups you wish to have in your calendar (lectures,
            exercises, seminars...) and click "Download" to download the
        ...
        <div className="howto-section">
          ...
          <p className="howto-section-text">
            Import the .ics-file to your calendar of choice, and voilà! All the
            classes you chose are automatically added to your calendar as
            events!
          </p>
          <img className="howto-image" src={example4} alt="example 4" />
          <p className="howto-section-text">
            Instructions for importing to{' '}
            <A href="https://support.google.com/calendar/answer/37118">
              Google Calendar
            </A>
            . If you use another calendar app, google for instructions if
            needed.
          </p>
        </div>
      </div>
